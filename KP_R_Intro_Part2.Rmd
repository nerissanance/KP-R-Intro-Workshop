...
#compare this to what we just learned using the basic syntax:
# subset_2 <- df.pid[df.pid$diabetes == 'pos' & df.pid$pressure >= 90,c("diabetes", "pressure")]
# 
# 
# dim(subset_1)
# head(subset_1)
