...
?tidyr
```
*A note about piped text*: below we use `%>%` text pipiing. This is equivalent to enclosing commands iwthint parantheses `()`, but it can be easier to read, especially when you have many commands on the same line.
...
#Spread by month
# spread <- flights %>% spread(key="date",month)
# 
# dim(flights)
# dim(spread)

####Gather
# gathered <- gather(flights, )
# 
# 
# ####Unite
