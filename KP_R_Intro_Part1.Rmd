...
First off, please run this code by clicking the green arrow at the top of the grey area below:
...
```{r}
animals <- animals[,c("Type", "Weight", "Height", "Progress")]
head(animals)
```
...
##Loading in data with the Rio package
...
df.who2 <- import("/Users/BettyFriedan/Google Drive/KP-R-Intro-Workshop/data/whostats_suicide.sas7bdat")
 dim(df.who2)
...
2. Read in the csv file of the WHO data and compare the results to the above SAS import.
```{r}
## YOUR CODE HERE
```
